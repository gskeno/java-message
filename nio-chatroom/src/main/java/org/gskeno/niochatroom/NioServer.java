...
public class NioServer {
    ...
    public void start() throws IOException {
        ...
        /**
         * 2. 通过ServerSocketChannel创建channel通道, 服务器角色
         */
        ...
        for (;;) { // while(true) c for;;
            ...
            while (iterator.hasNext()) {
                ...
                if (selectionKey.isAcceptable()) {
                    ...
                    acceptHandler(serverSocketChannel, selector, selectionKey);
                }
    ...
    private void acceptHandler(ServerSocketChannel serverSocketChannel,
                               Selector selector, SelectionKey selectionKey)
            throws IOException {
        /**
        ...
        // 绑定一个 "对象", 通过原子类 AtomicReferenceFieldUpdater为sk设置属性
        sk.attach("Student");
    ...
    private void readHandler(SelectionKey selectionKey, Selector selector)
        ...
        System.out.println("服务端接收到:" + request);
